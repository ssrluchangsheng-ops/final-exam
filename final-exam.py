...
# -----------------------------
# 3. Sidebar filters for sales data
...
# 6.4 Display full inventory table with highlighting
...
# Apply style to the filtered_inv DataFrame
